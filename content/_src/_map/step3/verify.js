 ...
 *
 * Usage:
 *   node _map/step3/verify.js <slug>
 *
 * Example:
 *   node _map/step3/verify.js index
 *   node _map/step3/verify.js about-us
 *
 * Paths (relative to _src/):
 *   Template : _map/step3/templates/{slug}.html
 *   Page JSON: _map/step3/pages/{slug}.json
 *   Shared   : _map/step3/pages/_shared.json
...
const pageJsonPath = path.join(stepDir, "pages", `${fileSlug}.json`);
const sharedJsonPath = path.join(stepDir, "pages", "_shared.json");
