...
(function () {
  ...
  var DICT = {
    en: {
      ...
      fineprint: "(Requires a 9-month contract or longer)",
      hero_email_ph: "Enter your email",
      hero_cta: "Claim your free AI Exposure Diagnostic Report",
      ...
      modal_sub: "Once submitted, our digital strategist will prepare your free AI Exposure Diagnostic Report as soon as possible.",
      modal_ph_name: "First name *",
      modal_ph_phone: "Contact number *",
      modal_ph_email: "Email address *",
      modal_ph_website: "Website (optional)",
      modal_submit: "Claim your free AI Exposure Diagnostic Report",
      /* ---- thank-you page ---- */
      back_btn: "Back to the previous page",
      ty_title: 'Your report is on the way!<br><span class="accent">We’ve received your inquiry.</span>',
      ty_sub: "Your dedicated digital strategist will contact you within one business day and prepare your free AI Exposure Diagnostic Report.",
